...
class TestConfigSurface:
    def test_rts_names_present_with_matching_defaults(self, clients):
        ...
        # The frozen baseline above must still describe the live reference —
        # a mismatch means the pinned image changed under us.
        assert reference_cfg == RTS_CONFIG_DEFAULTS
...
class TestValueValidation:
    ...
    def test_encoding_values(self, clients):
        ...
        for encoding in ("compressed", "uncompressed", "COMPRESSED"):
            assert reference.set_outcome("ts-encoding", encoding) == "ok"
